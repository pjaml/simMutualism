...
$$
\frac{dP}{dt} = P\left[ (1 - \delta_P) r_P + \delta_P \left( c_1 \left[\frac{\alpha_{P1} F_1}{h_{P1} + F_1}  + \frac{\alpha_{P2} F_2}{h_{P2} + F_2} \right] \right) - \delta_{F1} \left( q_1 \left[ \frac{\beta_{P} F_1}{e_P + P} \right] \right) - \delta_{F2} \left( q_1 \left[ \frac{\beta_{P} F_2}{e_P + P} \right] \right) - d_{P} P \right]
$$
...
$$
\frac{dF_1}{dt} = F_1[(1 - \delta_{F1})r_{F1} + \delta_{F1} \left( c_2 \left[\frac{\alpha_{F1} P}{h_{F1} + P} \right] \right) - \delta P \left(q_2  \left[ \frac{\beta_{F1} P}{e_{F1} + F_1} \right] \right) - \tau_{12} F_2 - d_{F1} F_1]
$$
...
$$
\frac{dF_2}{dt} = F_2[(1 - \delta_{F2}) r_{F2} + \delta_{F2} \left(c_2 \left[\frac{\alpha_{F2} P}{h_{F2} + P} \right] \right) - \delta P \left(q_2  \left[ \frac{\beta_{F2} P}{e_{F2} + F_2} \right] \right) - \tau_{21} F_1 - d_{F2} F_2]
$$

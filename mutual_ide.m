...
tspan = [0, 10];
r_p = 0.3;
r_f = [0.30 0.30]; %F1 and F2, respectively
alpha_pf = [0.5 0.5];
alpha_fp = [0.5 0.5];
q1 = 1.0;
q2 = 1.0;
...
while i < iterations
    ...
    dispersal_phase(nodes, f_P, f_F1, f_F2, n_P, n_F1, n_F2);
%   DISPERSAL
    ...
    if (i == iterations)
        ...
        if issteadystate(speed_inst_P, steady_state_threshold) || issteadystate(speed_inst_F1, steady_state_threshold) || issteadystate(speed_inst_F2, steady_state_threshold)

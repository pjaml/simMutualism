...
% normalize for arrows of equal length
% works, but arrows seem slightly off near isoclines
u = dN1 ./ sqrt(dN1 .^ 2 + dN2 .^ 2);
w = dN2 ./ sqrt(dN2 .^ 2 + dN2 .^ 2);

% generate vector field
figure
quiver(N1, N2, u, w, 0.35)
hold on

...
lowval = 1e-9;
diameter = 3600;  %total size of landscape along positive x-axis (so technically half the size of the total landscape)
...
%% Find the range sizes for each species
...
%% Plot the spread speed over iterations
clf;
